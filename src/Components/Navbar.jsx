...
const Navbar = ({ setShowLogin }) => {
  ...
  return (
    <nav className="relative container mx-auto py-5 px-5 md:px-10 lg:px-20">
      ...
      {isOpen && (
        <ul
          className={`md:hidden flex flex-col items-center gap-8 bg-[#ff6347] rounded p-10 transition-transform duration-500 ease-in-out transform absolute h-[55vh] w-[90vw] top-20 left-1/2 -translate-x-1/2 z-50 ${
            isOpen
